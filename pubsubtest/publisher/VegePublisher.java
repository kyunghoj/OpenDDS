...
public class VegePublisher {

    private static final int N_MSGS = 40;

    private static final String[] mVeges =
    {"Carrot", "Cabbage", "Spinach", "Lettuce", "Pick Fruits"};
    ...
    public static void main(String[] args) {
        ...
        MsgTypeSupportImpl servant = new MsgTypeSupportImpl();
        if (servant.register_type(dp, "") != RETCODE_OK.value) {
            System.err.println("ERROR: register_type failed");
            return;
        }

        Topic top = dp.create_topic("Vegetable", 
        ...
        MsgDataWriter mdw = MsgDataWriterHelper.narrow(dw);
        Msg msg = new Msg();
        msg.subject_id = 98;
        int handle = mdw.register_instance(msg);
        msg.from = "VegePublisher";
        msg.subject = "Vegetable";
        msg.count = 0;
